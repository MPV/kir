...
// container images of every workload it contains, using config for the kinds it describes and structural inference for the rest. Documents are
...
// Kubernetes object. Whether its images are looked up or inferred is
// k8s.Config.FindImages's business; either way no list of supported kinds is
// consulted, and a custom resource the Kubernetes scheme has never heard of is
// read on the same terms as a Deployment.
